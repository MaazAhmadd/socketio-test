...
// get /room/userrooms
router.get("/room/userrooms", authUser, async function (req, res) {
	// Pagination setup
...
// post /room/makeRoom
router.post("/room/makeRoom", authUser, async function (req, res) {
...
router.get("/room/getRoom/:roomId", authUser, async function (req, res) {
...
router.delete("/room/deleteAllRooms", async function (req, res) {
